...
export default function HistoryView({ sessions, onDeleteSession, onEditSession }: HistoryViewProps) {
                    ...
                    {!isConfirming && (
                      <>
                        <button
                          ...
                          className="w-6 h-6 rounded-full flex items-center justify-center text-charcoal-muted/40 active:bg-accent/10 active:text-accent transition-colors"
                      ...
                      {sessionId && !isConfirming && (
                        <>
                          <button
                            ...
                            className="w-5 h-5 rounded-full flex items-center justify-center text-charcoal-muted/30 active:text-accent transition-colors"
                            aria-label="Edit session"
                          >
